...
from algorithms import PCL_MS_DQNGFlowNet
...
def train_pcl_ms_dqn(
    ...
    if replay_buffer_size > 0:
        replay_buffer =  ReplayBuffer(
            env, objects_type="trajectories", capacity=replay_buffer_size
        )
    ...
    for iteration in trange(n_iterations):
        ...
        if replay_buffer is not None:
            ...
            if iteration > algo_config.learning_starts:
                training_objects= replay_buffer.sample( n_trajectories=general_config.n_envs)            
